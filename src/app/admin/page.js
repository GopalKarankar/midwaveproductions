...
export const metadata = {
  title: "Admin Overview - Midwave Productions",
};
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="border border-border p-6">
          ...
          <div className="flex flex-col gap-2 text-sm">
            <a href="/admin/artists" className="text-accent hover:text-accent-hover transition-colors">
              Manage Artists →
            </a>
            <a href="/admin/bookings" className="text-accent hover:text-accent-hover transition-colors">
              Review Bookings →
            </a>
            <a href="/admin/users" className="text-accent hover:text-accent-hover transition-colors">
              Manage Users →
            </a>
            <a href="/admin/media" className="text-accent hover:text-accent-hover transition-colors">
              Browse Media →
            </a>
          </div>
        </div>
