...
export const metadata = {
  ...
  description: "Privacy policy and data handling practices of Midwave Productions.",
};

export default async function PrivacyPage() {
  const legalPages = await getLegalPages();
  const paragraphs = legalPages.privacy ? paragraphsFromText(legalPages.privacy) : null;
